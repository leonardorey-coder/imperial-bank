...
const benefits: Benefit[] = [
    {
        ...
        title: 'Sin anualidad',
        description: 'Una tarjeta sin costos ocultos. Sin anualidad el primer año y sin comisiones sorpresa.',
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: 'Notificaciones instantáneas de cada compra y recordatorios de fecha de pago.',
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'Límites responsables',
        description: 'Línea de crédito acorde a tu capacidad. Control desde la app para ajustar según necesites.',
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
