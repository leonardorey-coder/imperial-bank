...
export default function CardScrollTarjetas() {
            ...
            content: (
                <div className="text-center max-w-2xl">
                    <p className="text-4xl md:text-6xl font-serif text-white leading-tight drop-shadow-lg">
                        Tres niveles. <span className="text-[var(--muted-orange)] italic">Una experiencia.</span>
                    </p>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="text-center max-w-2xl">
                    <p className="text-4xl md:text-6xl font-serif text-white leading-tight drop-shadow-lg">
                        Diseñado para <br />
                        <span className="italic font-display text-[var(--muted-orange)]">acompañarte.</span>
                    </p>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="text-center">
                    <button
                        onClick={() => {
                            document.getElementById('tarjetas-info')?.scrollIntoView({ behavior: 'smooth' });
                        }}
    ...
    useEffect(() => {
        const loadImages = async () => {
            try {
                const response = await fetch('/frames-tarjetas/manifest.json');
    ...
    const drawFrame = useCallback(
        (frameIndex: number) => {
            ...
            // Draw Background Image (Always Cover)
            if (bgCtx) {
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    >
                        ...
                        <p
                            className="text-xl md:text-3xl text-white/90 font-display italic whitespace-nowrap drop-shadow-lg"
                            style={{
                                letterSpacing: `${letterSpacing * 0.3}em`,
                                transition: 'letter-spacing 0.05s ease-out',
                            }}
                        >
                            Básica. Control. Imperial.
                        </p>
                    </div>
                </div>
