...
export default function CardScrollImperial() {
    ...
    // Text overlays configuration - Dark blue themed for Imperial card
    const overlays: TextOverlay[] = [
            ...
            content: (
                <div className="text-center max-w-2xl">
                    <p className="text-4xl md:text-6xl font-serif text-white leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                        Exclusividad <span className="italic">sin límites.</span>
                    </p>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="text-center max-w-2xl">
                    <p className="text-4xl md:text-6xl font-serif text-white leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                        Beneficios premium. <br />
                        <span className="italic font-display">Atención personalizada.</span>
                    </p>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="text-center">
                    <button
                        onClick={() => {
                            document.getElementById('specs-imperial')?.scrollIntoView({ behavior: 'smooth' });
                        }}
                        className="px-8 py-4 bg-[var(--imperial-blue)] text-white font-serif tracking-wide rounded-sm hover:brightness-110 transition-all duration-300 text-lg shadow-lg hover:shadow-[var(--imperial-blue)]/50 border border-white/20"
                    >
    ...
    // Load images from frames-3
    useEffect(() => {
        const loadImages = async () => {
            try {
                const response = await fetch('/frames-3/manifest.json');
    ...
    // Loading screen - Dark blue themed
    if (!isLoaded) {
        return (
    ...
    return (
        ...
        >
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                {/* Dynamic title with letter-spacing effect - Dark blue themed */}
                <div
                ...
                >
                    ...
                    >
                        ...
                        <p
                            className="text-xl md:text-3xl text-white/90 font-display italic whitespace-nowrap drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]"
                            style={{
                                letterSpacing: `${letterSpacing * 0.3}em`,
                                transition: 'letter-spacing 0.05s ease-out',
                            }}
                        >
                            Exclusividad. Beneficios sin límites.
                        </p>
                    </div>
                </div>
                ...
                {/* Scroll indicator - Dark blue themed */}
                {scrollProgress < 0.1 && (
                    <motion.div
